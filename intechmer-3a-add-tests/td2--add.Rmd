...
- 1973 année la plus mortelle
- Pic de morts en été et au plus bas en février
...
- Février 1976 plus haut que *prévu*
- Pour plusieurs mois (janvier, de mars à juin et d'août à décembre,), hausse à partir de 1975 ou 1976

```{r, echo = FALSE}
ggplot(Acc2, aes(Annee, value)) +
  geom_line(linewidth = 1) + 
  labs(x = "", y = "Nombre de morts") +
  theme_minimal() +
  facet_wrap(~ Mois)
```
