...
Vous trouverez sur le site [rmarkdown](https://daringfireball.net/projects/markdown/) beaucoup d'informations et de compléments sur cette librairie. Beaucoup sont résumées dans ce [document](https://utstat.utoronto.ca/reid/sta2201s/rmarkdown-reference.pdf) et [celui-ci](https://posit.co/wp-content/uploads/2022/10/rmarkdown-1.pdf).
